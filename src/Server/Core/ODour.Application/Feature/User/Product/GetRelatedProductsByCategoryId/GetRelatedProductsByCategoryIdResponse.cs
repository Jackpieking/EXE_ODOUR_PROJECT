...
public sealed class GetRelatedProductsByCategoryIdResponse : IFeatureResponse
{
    public GetRelatedProductsByCategoryIdResponseStatusCode StatusCode { get; init; }
