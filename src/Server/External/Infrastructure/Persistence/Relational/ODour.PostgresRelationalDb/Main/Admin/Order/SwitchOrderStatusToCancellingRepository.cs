...
internal sealed class SwitchOrderStatusToCancellingRepository
    : ISwitchOrderStatusToCancellingRepository
{
    private readonly Lazy<DbContext> _context;

    public SwitchOrderStatusToCancellingRepository(Lazy<DbContext> context)
    {
        _context = context;
    }
            ...
            .ExecuteAsync(operation: async () =>
            {
                ...
                try
                {
                    var processingOrderStatusId = Guid.Parse(
                        input: "2f3eae5b-d4ed-4fff-ab1c-6a538721ffca"
                    );
