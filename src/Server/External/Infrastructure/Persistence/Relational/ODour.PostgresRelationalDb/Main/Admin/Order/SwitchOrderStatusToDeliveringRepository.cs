...
internal sealed class SwitchOrderStatusToDeliveringRepository
    : ISwitchOrderStatusToDeliveringRepository
{
    private readonly Lazy<DbContext> _context;

    public SwitchOrderStatusToDeliveringRepository(Lazy<DbContext> context)
    {
        _context = context;
    }
            ...
            .ExecuteAsync(operation: async () =>
            {
                ...
                try
                {
                    var processingOrderStatusId = Guid.Parse(
                        input: "3a398200-af38-4832-82d9-ed65c248041b"
                    );
