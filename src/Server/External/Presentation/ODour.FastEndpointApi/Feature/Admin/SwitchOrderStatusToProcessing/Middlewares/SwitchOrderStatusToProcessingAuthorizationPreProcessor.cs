    ...
    : PreProcessor<SwitchOrderStatusToProcessingRequest, SwitchOrderStatusToProcessingStateBag>
{
    ...
    )
    {
        ...
        // Get refresh token.
        var refreshToken =
            await unitOfWork.Value.SwitchOrderStatusToProcessingRepository.GetRefreshTokenQueryAsync(
        ...
        var isUserTemporarilyRemoved =
            await unitOfWork.Value.SwitchOrderStatusToProcessingRepository.IsUserBannedQueryAsync(
                userId: foundUser.Id,
                ct: ct
            );
