    ...
    : PreProcessor<GetUserOrdersRequest, GetUserOrdersStateBag>
{
    ...
    )
    {
        ...
        var cacheKey = $"{nameof(GetUserOrdersRequest)}__AUTHORIZATION_CHECK__{accessTokenId}";
        ...
        if (Equals(objA: foundAuthorizedAccessToken, objB: AppCacheModel<bool>.NotFound))
        {
            ...
            var isRefreshTokenFound =
                await unitOfWork.Value.GetUserOrdersRepository.IsRefreshTokenFoundQueryAsync(
